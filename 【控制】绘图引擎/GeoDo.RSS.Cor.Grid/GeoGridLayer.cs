    ...
    public class GeoGridLayer : Layer, IRenderLayer, IGridLayer
    {
        ...
        */
        ...
        private bool ComputeValidGeoRange()
        {
            ...
            {
                Range lonRange = new Range(Math.Min(-180, _beginLon), Math.Max(180, _endLon));
                _validLatRange.MinValue = Math.Min(-90, _beginLat);
                _validLatRange.MaxValue = Math.Max(90, _endLat);
        ...
        computeBufferSizeLine:
            ...
            _lonLines = (int)(((maxLon - minLon) / _gridSpan) + 1d);
