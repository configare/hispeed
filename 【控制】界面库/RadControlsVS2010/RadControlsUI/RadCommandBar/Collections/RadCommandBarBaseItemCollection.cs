...
{
    public delegate void RadCommandBarBaseItemCollectionItemChangedDelegate(RadCommandBarBaseItemCollection changed, RadCommandBarBaseItem target, ItemsChangeOperation operation);
    ...
    ///    </para>
    /// </summary>
    [Editor(DesignerConsts.RadCommandBarBaseItemCollectionEditorString, typeof(UITypeEditor))]
    [Serializable()]
    //[ListBindable(false)]
    [DebuggerDisplay("Count = {Count}")]
    public class RadCommandBarBaseItemCollection : CollectionBase, IEnumerable<RadCommandBarBaseItem>
    {
        #region Events
        /// <summary>
        ...
        protected virtual void OnItemsChanged(RadCommandBarBaseItem target, ItemsChangeOperation operation)
        {
            ...
            switch (operation)
            {
                case ItemsChangeOperation.Cleared:
                    foreach (RadCommandBarBaseItem item in this)
                    {
        ...
        protected override void OnInsertComplete(int index, object value)
        {
            ...
            OnItemsChanged(value as RadCommandBarBaseItem, ItemsChangeOperation.Inserted);            
        }
        ...
        private Type[] itemTypes = new Type[] { typeof(RadCommandBarBaseItemCollection) };
        ...
        {
            return new RadCommandBarBaseItemEnumerator(this);
        }
        ...
        public new RadCommandBarBaseItemEnumerator GetEnumerator()
        {
            return new RadCommandBarBaseItemEnumerator(this);
        }
        ...
        {
            OnItemsChanged(value as RadCommandBarBaseItem, ItemsChangeOperation.Removing);
        }
        ...
        {
            RadCommandBarBaseItem[] res = new RadCommandBarBaseItem[this.Count];
            this.CopyTo(res, 0);
            return res;
        }
        ...
        public RadCommandBarBaseItem this[int index]
        {
            get
            {
                return (RadCommandBarBaseItem)List[index];
            }
            set
            {
                List[index] = value;
        ...
        public RadCommandBarBaseItem this[string itemName]
        {
            get
            {
                for (int i = 0; i < this.List.Count; i++)
                {
                    RadCommandBarBaseItem currRitem = (RadCommandBarBaseItem)this.List[i];
        ...
        /// </summary>
        public class RadCommandBarBaseItemEnumerator : IEnumerator, IEnumerator<RadCommandBarBaseItem>
        {
            ...
            public RadCommandBarBaseItem Current
            {
                get
                {
                    return ((RadCommandBarBaseItem)(baseEnumerator.Current));
                }
            }
    ...
    //public class RadCommandBarBaseItemCollection : RadItemOwnerCollection
    //{
    //    public new RadCommandBarBaseItem this[int index]
    //    {
    //        get
    //        {
    //            return (RadCommandBarBaseItem)List[index];
    ...
    //        }
    //    }
    //    public new RadCommandBarBaseItem this[string itemName]
    //    {
    //        get
    //        {
    //            return (RadCommandBarBaseItem)base[itemName];
    //        }
    //    }
    //}
}   