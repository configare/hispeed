...
namespace Telerik.WinControls.UI
{
    ...
    ///    </para>
    /// </summary>
    [Editor(DesignerConsts.CommandBarRowElementCollectionEditorString, typeof(UITypeEditor))]
    [Serializable()]
    //[ListBindable(false)]
    [DebuggerDisplay("Count = {Count}")]
    public class RadCommandBarLinesElementCollection : CollectionBase, IEnumerable<CommandBarRowElement>
    {
        #region Events
        /// <summary>
        ...
        protected virtual void OnItemsChanged(CommandBarRowElement target, ItemsChangeOperation operation)
        {
            ...
            switch (operation)
            {
                case ItemsChangeOperation.Cleared:
                    foreach (CommandBarRowElement item in this)
                    {
        ...
        protected override void OnInsertComplete(int index, object value)
        {
            ...
            OnItemsChanged(value as CommandBarRowElement, ItemsChangeOperation.Inserted);            
        }
        ...
        private Type[] itemTypes = new Type[] { typeof(RadCommandBarLinesElementCollection) };
        ...
        {
            return new CommandBarRowElementEnumerator(this);
        }
        ...
        public new CommandBarRowElementEnumerator GetEnumerator()
        {
            return new CommandBarRowElementEnumerator(this);
        }
        ...
        {
            OnItemsChanged((CommandBarRowElement)value, ItemsChangeOperation.Inserting);
        }

        protected override void OnRemove(int index, object value)
        {
            OnItemsChanged(value as CommandBarRowElement, ItemsChangeOperation.Removing);
        }
        ...
        {
            CommandBarRowElement[] res = new CommandBarRowElement[this.Count];
            this.CopyTo(res, 0);
            return res;
        }
        ...
        public CommandBarRowElement this[int index]
        {
            get
            {
                return (CommandBarRowElement)List[index];
            }
            set
            {
                List[index] = value;
        ...
        public CommandBarRowElement this[string itemName]
        {
            get
            {
                for (int i = 0; i < this.List.Count; i++)
                {
                    CommandBarRowElement currRitem = (CommandBarRowElement)this.List[i];
        ...
        /// </summary>
        public class CommandBarRowElementEnumerator : IEnumerator, IEnumerator<CommandBarRowElement>
        {
            ...
            public CommandBarRowElement Current
            {
                get
                {
                    return ((CommandBarRowElement)(baseEnumerator.Current));
                }
            }
