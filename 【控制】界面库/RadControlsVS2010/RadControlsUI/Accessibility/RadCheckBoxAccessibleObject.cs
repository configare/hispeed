...
{
    [ComVisible(true)]
    public class RadCheckBoxAccessibleObject : Control.ControlAccessibleObject
    {
        // Methods
        ...
        public override AccessibleStates State
        {
            ...
            get
            {
                ...
                switch (((RadCheckBox)base.Owner).ToggleState)
                {
                    case ToggleState.On:
                ...
                if (((RadCheckBox)base.Owner).RootElement.IsMouseDown)
                {
