...
namespace Telerik.WinControls
{
    internal sealed class SR
    {
        ...
        public static object GetObject(string name)
        {
            ...
            return sr1.resources.GetObject(name, SR.Culture);
        }
        ...
        public static string GetString(string name)
        {
            ...
            return sr1.resources.GetString(name, SR.Culture);
        }
        ...
        public static string GetString(string name, params object[] args)
        {
            ...
            string text1 = sr1.resources.GetString(name, SR.Culture);
            ...
            {
                string text2 = args[num1] as string;
                if ((text2 != null) && (text2.Length > 0x400))
                {
                    args[num1] = text2.Substring(0, 0x3fd) + "...";
                }
            }
        ...
        private static object InternalSyncObject
        {
            get
            {
                if (SR.s_InternalSyncObject == null)
                {
                    ...
                    Interlocked.CompareExchange(ref SR.s_InternalSyncObject, obj1, (object) null);
                }
