...
namespace Telerik.WinControls.UI.Multimedia
{
    ...
    /// </summary>
    [Flags]
    internal enum VMRPresentationFlags
    {
        None = 0,
    ...
    /// </summary>
    [Flags]
    internal enum VMRSurfaceAllocationFlags
    {
        None = 0,
    ...
    internal struct VMRPresentationInfo
    {
    ...
    /// </summary>
    [StructLayout(LayoutKind.Sequential)]
    internal struct VMRAllocationInfo
    {
    ...
    /// </summary>
    [Flags]
    internal enum VMRDeinterlaceTech
    {
        Unknown = 0x0000,
    ...
    /// </summary>
    [Flags]
    internal enum VMRDeinterlacePrefs
    {
        None = 0,
        NextBest = 0x01,
        BOB = 0x02,
    ...
    /// </summary>
    internal enum VMRAspectRatioMode
    {
        None,
        LetterBox
    }
    ...
    /// </summary>
    [StructLayout(LayoutKind.Sequential)]
    internal struct VMRDeinterlaceCaps
    {
        public int dwSize;
    ...
    /// </summary>
    [StructLayout(LayoutKind.Sequential)]
    internal struct VMRVideoStreamInfo
    {
    ...
    internal struct VMRMonitorInfo
    {
        public VMRGuid guid;
    ...
    internal interface IVMRImagePresenter
    {
        [PreserveSig]
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IVMRSurfaceAllocator
    {
        [PreserveSig]
        int AllocateSurface(
            [In] IntPtr dwUserID,
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IVMRSurfaceAllocatorNotify
    {
        [PreserveSig]
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IVMRSurface
    {
        [PreserveSig]
        int IsSurfaceLocked();
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IVMRImagePresenterExclModeConfig : IVMRImagePresenterConfig
    {
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IVMRAspectRatioControl
    {
        [PreserveSig]
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IVMRDeinterlaceControl
    {
        [PreserveSig]
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IVMRImagePresenterConfig
    {
        [PreserveSig]
        int SetRenderingPrefs([In] VMRRenderPrefs dwRenderFlags);
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IVMRMonitorConfig
    {
        [PreserveSig]
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IVMRVideoStreamControl
    {
        [PreserveSig]
