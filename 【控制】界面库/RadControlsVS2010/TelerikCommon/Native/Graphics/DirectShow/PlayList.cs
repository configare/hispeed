...
namespace Telerik.WinControls.UI.Multimedia
{
    ...
    /// </summary>
    internal enum AMPlayListItemFlags
    {
        CanSkip = 0x1,
        CanBind = 0x2
    }
    ...
    internal interface IAMPlayListItem
    {
        int GetFlags(
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IAMPlayList
    {
        int GetFlags(
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface ISpecifyParticularPages
    {
        int GetPages(
