...
namespace Telerik.WinControls.UI.Multimedia
{
    ...
    /// </summary>
    internal enum StreamBufferAttrDataType
    {
        DWord = 0,
        String = 1,
        Binary = 2,
    ...
    /// From unnamed structure
    /// </summary>
    internal enum StreamBufferEventCode
    {
    ...
    /// </summary>
    sealed internal class StreamBufferRecording
    {
    ...
    internal struct StreamBufferAttribute
    {
    ...
    internal interface IStreamBufferInitialize
    {
        [PreserveSig]
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IStreamBufferSink
    {
        [PreserveSig]
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IStreamBufferSink2 : IStreamBufferSink
    {
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IStreamBufferSink3 : IStreamBufferSink2
    {
        #region IStreamBufferSink Methods
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IStreamBufferSource
    {
        [PreserveSig]
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IStreamBufferRecordControl
    {
        [PreserveSig]
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IStreamBufferRecComp
    {
        [PreserveSig]
        int Initialize(
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IStreamBufferRecordingAttribute
    {
        [PreserveSig]
        int SetAttribute(
            [In] int ulReserved,
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IEnumStreamBufferRecordingAttrib
    {
        [PreserveSig]
        int Next(
            [In] int cRequest,
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IStreamBufferConfigure
    {
        [PreserveSig]
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IStreamBufferConfigure2 : IStreamBufferConfigure
    {
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IStreamBufferMediaSeeking : IMediaSeeking
    {
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IStreamBufferMediaSeeking2 : IStreamBufferMediaSeeking
    {
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IStreamBufferDataCounters
    {
        [PreserveSig]
