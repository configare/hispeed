...
namespace Telerik.WinControls.UI.Multimedia
{
    ...
    internal struct AMVABufferInfo
    {
    ...
    /// </summary>
    [StructLayout(LayoutKind.Sequential)]
    internal struct AMVAUncompDataInfo
    {
    ...
    /// </summary>
    [StructLayout(LayoutKind.Sequential)]
    internal struct AMVAUncompBufferInfo
    {
    ...
    /// </summary>
    [StructLayout(LayoutKind.Sequential)]
    internal struct AMVAInternalMemInfo
    {
    ...
    /// </summary>
    [StructLayout(LayoutKind.Sequential)]
    internal struct AMVACompBufferInfo
    {
    ...
    /// </summary>
    [StructLayout(LayoutKind.Sequential)]
    internal struct AMVABeginFrameInfo
    {
    ...
    /// </summary>
    [StructLayout(LayoutKind.Sequential)]
    internal struct AMVAEndFrameInfo
    {
    ...
    /// Not from DirectShow
    /// </summary>
    internal enum MPEGAudioDivider
    {
        CDAudio = 1,
        FMRadio = 2,
        AMRadio = 4
    ...
    /// Not from DirectShow
    /// </summary>
    internal enum MPEGAudioAccuracy
    {
        Best = 0x0000,
        High = 0x4000,
        Full = 0x8000
    ...
    /// Not from DirectShow
    /// </summary>
    internal enum MPEGAudioChannels
    {
        Mono = 1,
        Stereo = 2
    }
    ...
    /// </summary>
    internal enum AcmMpegHeadLayer : short
    {
        Layer1 = 1,
        Layer2,
        Layer3
    ...
    /// </summary>
    internal enum AcmMpegHeadMode : short
    {
        Stereo = 1,
        JointStereo,
        DualChannel,
    ...
    /// </summary>
    [Flags]
    internal enum AcmMpegHeadFlags : short
    {
        None = 0x0,
        PrivateBit = 0x1,
        Copyright = 0x2,
    ...
    internal class MPEG1WaveFormat
    {
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IGetCapabilitiesKey
    {
        [PreserveSig]
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IAMVideoAcceleratorNotify
    {
        [PreserveSig]
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IAMVideoAccelerator
    {
        [PreserveSig]
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IAMFilterGraphCallback
    {
        [PreserveSig]
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IDirectDrawMediaSample
    {
        [PreserveSig]
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IDirectDrawMediaSampleAllocator
    {
        [PreserveSig]
        int GetDirectDraw(
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IConfigAsfWriter
    {
        [PreserveSig,
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IAMDirectSound
    {
        [PreserveSig]
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IAMWstDecoder
    {
        [PreserveSig]
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IMpegAudioDecoder
    {
        [PreserveSig]
