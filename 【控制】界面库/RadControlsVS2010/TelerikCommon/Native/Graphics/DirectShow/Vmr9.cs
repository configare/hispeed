...
namespace Telerik.WinControls.UI.Multimedia
{
    ...
    /// </summary>
    [Flags]
    internal enum VMR9PresentationFlags
    {
        None = 0,
    ...
    /// </summary>
    [Flags]
    internal enum VMR9SurfaceAllocationFlags
    {
        None = 0,
    ...
    /// </summary>
    [Flags]
    internal enum VMR9ProcAmpControlFlags
    {
        None = 0,
    ...
    /// </summary>
    [Flags]
    internal enum VMR9DeinterlaceTech
    {
        Unknown = 0x0000,
    ...
    /// </summary>
    [Flags]
    internal enum VMR9AlphaBitmapFlags
    {
        None = 0,
        Disable = 0x00000001,
        hDC = 0x00000002,
    ...
    /// </summary>
    [Flags]
    internal enum VMR9DeinterlacePrefs
    {
        None = 0,
        NextBest = 0x01,
        BOB = 0x02,
    ...
    internal struct VMR9PresentationInfo
    {
    ...
    /// </summary>
    [StructLayout(LayoutKind.Sequential)]
    internal struct VMR9AllocationInfo
    {
    ...
    /// </summary>
    [StructLayout(LayoutKind.Sequential)]
    internal struct VMR9ProcAmpControl
    {
    ...
    internal struct VMR9MonitorInfo
    {
        public int uDevID;
    ...
    /// </summary>
    [StructLayout(LayoutKind.Sequential)]
    internal struct VMR9DeinterlaceCaps
    {
        public int dwSize;
    ...
    /// </summary>
    [StructLayout(LayoutKind.Sequential)]
    internal struct VMR9AlphaBitmap
    {
    ...
    /// </summary>
    [StructLayout(LayoutKind.Sequential)]
    internal struct VMR9ProcAmpControlRange
    {
        public int dwSize; // should be 24
    ...
    internal interface IVMRSurface9
    {
        [PreserveSig]
        int IsSurfaceLocked();
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IVMRImagePresenter9
    {
        [PreserveSig]
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IVMRSurfaceAllocatorEx9 : IVMRSurfaceAllocator9
    {
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IVMRSurfaceAllocatorNotify9
    {
        [PreserveSig]
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IVMRSurfaceAllocator9
    {
        [PreserveSig]
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IVMRDeinterlaceControl9
    {
        [PreserveSig]
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IVMRImagePresenterConfig9
    {
        [PreserveSig]
        int SetRenderingPrefs([In] VMR9RenderPrefs dwRenderFlags);
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IVMRMixerBitmap9
    {
        [PreserveSig]
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IVMRMixerControl9
    {
        [PreserveSig]
        int SetAlpha(
            [In] int dwStreamID,
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IVMRMonitorConfig9
    {
        [PreserveSig]
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IVMRVideoStreamControl9
    {
        [PreserveSig]
