...
namespace Telerik.WinControls.UI.Multimedia
{
    ...
    sealed internal class MsResults
    {
        private MsResults()
        {
    ...
    internal class AMMultiMediaStream
    {
    }
    ...
    internal class AMMediaTypeStream
    {
    }
    ...
    internal class AMDirectDrawStream
    {
    }
    ...
    /// </summary>
    [Flags]
    internal enum CompletionStatusFlags
    {
        None = 0x0,
        NoUpdateOk = 0x1,
        Wait = 0x2,
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IMultiMediaStream
    {
        [PreserveSig]
        int GetInformation(
            out MMSSF pdwFlags,
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IStreamSample
    {
        [PreserveSig]
        int GetMediaStream(
            [MarshalAs(UnmanagedType.Interface)] out IMediaStream ppMediaStream
