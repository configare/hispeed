...
namespace Telerik.WinControls.UI.Multimedia
{
    ...
    /// </summary>
    internal enum KSPropertyIPSink
    {
        MulticastList,
        AdapterDescription,
        AdapterAddress
    ...
    /// </summary>
    internal enum MediaSampleContent
    {
        TransportPacket,
        ElementaryStream,
        Mpeg2PSI,
    ...
    /// </summary>
    [StructLayout(LayoutKind.Sequential)]
    internal struct BDANodeDescriptor
    {
    ...
    internal interface IBDA_NetworkProvider
    {
        [PreserveSig]
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IBDA_VoidTransform
    {
        [PreserveSig]
        int Start();
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IBDA_NullTransform
    {
        [PreserveSig]
        int Start();
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IEnumPIDMap
    {
        [PreserveSig]
        int Next(
            [In] int cRequest,
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IBDA_PinControl
    {
        [PreserveSig]
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IBDA_SignalStatistics
    {
        [PreserveSig]
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IBDA_Topology
    {
        [PreserveSig]
        int GetNodeTypes(
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IFrequencyMap
    {
        [PreserveSig]
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IBDA_AutoDemodulate
    {
        [PreserveSig]
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IBDA_DeviceControl
    {
        [PreserveSig]
        int StartChanges();
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IBDA_DigitalDemodulator
    {
        [PreserveSig]
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IBDA_EthernetFilter
    {
        [PreserveSig]
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IBDA_FrequencyFilter
    {
        [PreserveSig]
    ...
    internal interface IBDA_IPSinkControl
    {
        [PreserveSig]
        int GetMulticastList(
            out int pulcbSize,
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IBDA_IPSinkInfo
    {
        [PreserveSig]
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IBDA_IPV4Filter
    {
        [PreserveSig]
        int GetMulticastListSize(
            out int pulcbAddresses);
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IBDA_IPV6Filter
    {
        [PreserveSig]
        int GetMulticastListSize(
            out int pulcbAddresses);
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IBDA_LNBInfo
    {
        [PreserveSig]
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IMPEG2PIDMap
    {
        [PreserveSig]
        int MapPID(
            [In] int culPID,
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IBDA_SignalProperties
    {
        [PreserveSig]
