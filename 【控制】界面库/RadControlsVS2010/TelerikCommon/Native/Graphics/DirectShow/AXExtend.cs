...
namespace Telerik.WinControls.UI.Multimedia
{
    ...
    /// </summary>
    internal enum VideoCopyProtectionType
    {
        MacrovisionBasic,
        MacrovisionCBI
    }
    ...
    /// </summary>
    [Flags]
    internal enum AMPushSourceFlags
    {
        None = 0,
    ...
    /// </summary>
    internal enum VideoEncoderBitrateMode
    {
        ConstantBitRate = 0,
    ...
    /// </summary>
    [StructLayout(LayoutKind.Sequential)]
    internal struct RegFilterPins2
    {
    ...
    internal struct RegFilter2Union
    {
    ...
    /// </summary>
    [StructLayout(LayoutKind.Sequential)]
    internal struct TimeCodeSample
    {
        public long qwTick;
    ...
    /// </summary>
    [StructLayout(LayoutKind.Sequential)]
    internal struct CodecAPIEventData
    {
        public Guid guid;
    ...
    /// </summary>
    [StructLayout(LayoutKind.Sequential)]
    internal struct AMCOPPSignature
    {
    ...
    /// </summary>
    [StructLayout(LayoutKind.Sequential)]
    internal struct AMCOPPStatusInput
    {
        public Guid rApp;
    ...
    /// </summary>
    [StructLayout(LayoutKind.Sequential)]
    internal struct AMCOPPStatusOutput
    {
        public Guid macKDI;
        public int cbSizeData;
    ...
    /// </summary>
    [Flags]
    internal enum AMFilterMiscFlags
    {
        None = 0,
    ...
    /// </summary>
    [Flags]
    internal enum AMStreamInfoFlags
    {
        None = 0x00000000,
    ...
    /// </summary>
    internal enum AMAudioRendererStatParam
    {
        BreakCount = 1,
        SlaveMode,
        SilenceDur,
    ...
    /// </summary>
    internal enum DVDecoderResolution
    {
        r720x480 = 1000,
        r360x240 = 1001,
        r180x120 = 1002,
    ...
    /// </summary>
    [Flags]
    internal enum AMIntfSearchFlags
    {
        None = 0x00000000,
        InputPin = 0x00000001,
    ...
    /// </summary>
    [Flags]
    internal enum AMResCtlReserveFlags
    {
        Reserve = 0x00,
        UnReserve = 0x01
    }
    ...
    /// </summary>
    [Flags]
    internal enum AMStreamSelectInfoFlags
    {
        Disabled = 0x0,
        Enabled = 0x01,
        Exclusive = 0x02
    ...
    /// </summary>
    [Flags]
    internal enum AMStreamSelectEnableFlags
    {
        DisableAll = 0x0,
        Enable = 0x01,
        EnableAll = 0x02
    ...
    /// </summary>
    internal enum DVEncoderResolution
    {
        r720x480 = 2012,
        r360x240 = 2013,
        r180x120 = 2014,
    ...
    /// </summary>
    internal enum DVEncoderVideoFormat
    {
        NTSC = 2000,
        PAL = 2001
    }
    ...
    /// </summary>
    internal enum InterleavingMode
    {
        None,
        Capture,
        Full,
    ...
    /// </summary>
    internal enum AMTunerSubChannel
    {
        NoTune = -2,
        Default = -1
    }
    ...
    /// </summary>
    internal enum AMTunerSignalStrength
    {
    ...
    /// </summary>
    internal enum AMTunerEventType
    {
        Changed = 0x0001
    }
    ...
    /// </summary>
    [Flags]
    internal enum AMTVAudioEventType
    {
        None = 0,
        Changed = 0x0001
    }
    ...
    /// </summary>
    [Flags]
    internal enum VfwCompressDialogs
    {
        None = 0,
        Config = 0x01,
        About = 0x02,
    ...
    /// From ED_TRANSCAP*
    /// </summary>
    internal enum ExtTransportCaps
    {
        None = 0,
    ...
    /// From ED_MEDIA*
    /// </summary>
    internal enum ExtTransportMediaStates
    {
        None = 0,
    ...
    /// From ED_MODE*
    /// </summary>
    internal enum ExtTransportModes
    {
        None = 0,
    ...
    /// from ED_MEDIA* etc.
    /// </summary>
    internal enum ExtTransportStatus
    {
        None = 0,
    ...
    /// </summary>
    internal enum ExtTransportParameters
    {
        None = 0,
    ...
    /// </summary>
    [Flags]
    internal enum ExtTransportAudio
    {
        None = 0,
    ...
    /// From ED_EDIT*
    /// </summary>
    internal enum ExtTransportEdit
    {
    ...
    /// </summary>
    [StructLayout(LayoutKind.Sequential)]
    internal class AudioStreamConfigCaps
    {
        public Guid guid;
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IEnumRegFilters
    {
        [PreserveSig]
        int Next(
            [In] int cFilters,
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IFilterMapper
    {
        [PreserveSig]
        int RegisterFilter(
            [In] Guid clsid,
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IOverlayNotify
    {
        [PreserveSig]
        int OnPaletteChange(
            [In] int dwColors,
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IOverlayNotify2 : IOverlayNotify
    {
    ...
    internal interface ICaptureGraphBuilder
    {
        [PreserveSig]
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IDistributorNotify
    {
        [PreserveSig]
        int Stop();
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IBPCSatelliteTuner : IAMTuner
    {
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IAMTVAudioNotification
    {
        [PreserveSig]
    ...
    Obsolete("This interface has been deprecated.", false),
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IAMAnalogVideoEncoder
    {
        [PreserveSig]
    ...
    Obsolete("This interface has been deprecated.", false),
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IAMPhysicalPinInfo
    {
        [PreserveSig]
        int GetPhysicalType(
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IAMTimecodeReader
    {
        [PreserveSig]
        int GetTCRMode(
            [In] int Param,
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IAMTimecodeGenerator
    {
        [PreserveSig]
        int GetTCGMode(
            [In] int Param,
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IAMTimecodeDisplay
    {
        [PreserveSig]
    ...
    Obsolete("This interface has been deprecated.", false),
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IAMDevMemoryAllocator
    {
        [PreserveSig]
        int GetInfo(
    ...
    Obsolete("This interface has been deprecated.", false),
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IAMDevMemoryControl
    {
        [PreserveSig]
        int QueryWriteSync();
    ...
    Obsolete("This interface has been deprecated.", false),
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IDrawVideoImage
    {
        [PreserveSig]
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IDecimateVideoImage
    {
        [PreserveSig]
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IAMPushSource
    {
        [PreserveSig]
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IAMDeviceRemoval
    {
        [PreserveSig]
        int DeviceInfo(
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IEnumStreamIdMap
    {
        [PreserveSig]
        int Next(
            [In] int cRequest,
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IAMCertifiedOutputProtection
    {
        [PreserveSig]
        int KeyExchange(
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IGraphVersion
    {
        [PreserveSig]
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IDVSplitter
    {
        [PreserveSig]
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IAMStreamControl
    {
        [PreserveSig]
        int StartAt(
            [In] DsLong ptStart,
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IAMFilterMiscFlags
    {
        [PreserveSig]
        int GetMiscFlags();
    }
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IPersistMediaPropertyBag : IPersist
    {
        #region IPersist
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IMediaPropertyBag : IPropertyBag
    {
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IAMGraphStreams
    {
        [PreserveSig]
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IConfigAviMux
    {
        [PreserveSig]
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IConfigInterleaving
    {
        [PreserveSig]
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IFileSinkFilter2 : IFileSinkFilter
    {
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IVideoFrameStep
    {
        [PreserveSig]
        int Step(
            [In] int dwFrames,
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IAMTunerNotification
    {
        [PreserveSig]
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IAMTVTuner : IAMTuner
    {
        #region IAMTuner
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IAMAudioInputMixer
    {
        [PreserveSig]
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IAMDroppedFrames
    {
        [PreserveSig]
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IAMVfwCompressDialogs
    {
        [PreserveSig]
        int ShowDialog(
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IAMVideoCompression
    {
        [PreserveSig]
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IMediaEventSink
    {
        [PreserveSig]
        int Notify(
            [In] EventCode evCode,
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IAMClockSlave
    {
        [PreserveSig]
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IAMDecoderCaps
    {
        [PreserveSig]
        int GetDecoderCaps(
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IAMOverlayFX
    {
        [PreserveSig]
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IAMResourceControl
    {
        [PreserveSig]
        int Reserve(
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IAMStreamSelect
    {
        [PreserveSig]
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IAMVideoDecimationProperties
    {
        [PreserveSig]
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IFilterMapper3 : IFilterMapper2
    {
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IMpeg2Demultiplexer
    {
        [PreserveSig]
        int CreateOutputPin(
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IAMExtDevice
    {
        [PreserveSig]
        int GetCapability(
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IMPEG2StreamIdMap
    {
        [PreserveSig]
        int MapStreamId(
            [In] int ulStreamId,
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IAMExtTransport
    {
        [PreserveSig]
        int GetCapability(
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IAMGraphBuilderCallback
    {
        [PreserveSig]
#if USING_NET11
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IAMBufferNegotiation
    {
        [PreserveSig]
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IAMAudioRendererStats
    {
        [PreserveSig]
        int GetStatParam(
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IRegisterServiceProvider
    {
        [PreserveSig]
        int RegisterService(
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface ISeekingPassThru
    {
        int Init(
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IAMClockAdjust
    {
        [PreserveSig]
