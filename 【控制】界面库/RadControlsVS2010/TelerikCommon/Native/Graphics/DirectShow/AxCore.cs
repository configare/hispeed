...
namespace Telerik.WinControls.UI.Multimedia
{
    ...
    /// </summary>
    [Flags]
    internal enum AMSamplePropertyFlags
    {
        SplicePoint = 0x01,
        PreRoll = 0x02,
    ...
    /// </summary>
    [Flags]
    internal enum AMSeekingSeekingCapabilities
    {
        None = 0,
    ...
    /// </summary>
    [Flags]
    internal enum AMSeekingSeekingFlags
    {
        NoPositioning = 0x00,
    ...
    internal class AllocatorProperties
    {
        public int cBuffers;
        public int cbBuffer;
        public int cbAlign;
    ...
    /// </summary>
    [StructLayout(LayoutKind.Sequential)]
    internal class AMSample2Properties
    {
        public int cbData;
    ...
    internal interface IReferenceClock2 : IReferenceClock
    {
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IMemInputPin
    {
        [PreserveSig]
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IAMovieSetup
    {
        [PreserveSig]
        int Register();
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IMediaSample2 : IMediaSample
    {
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IMemAllocatorNotifyCallbackTemp
    {
        [PreserveSig]
        int NotifyRelease();
    }
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IMemAllocatorCallbackTemp : IMemAllocator
    {
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IMemAllocator
    {
        [PreserveSig]
        int SetProperties(
