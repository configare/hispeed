...
namespace Telerik.WinControls.UI.Multimedia
{
    ...
    internal struct BDATemplatePinJoint
    {
    ...
    /// </summary>
    [StructLayout(LayoutKind.Sequential)]
    internal struct KSBDAFrameInfo
    {
    ...
    /// </summary>
    [StructLayout(LayoutKind.Sequential)]
    internal struct MPEG2TransportStride
    {
        public int dwOffset;
    ...
    /// </summary>
    internal enum BinaryConvolutionCodeRate
    {
        RateNotSet = -1,
        RateNotDefined = 0,
        Rate1_2 = 1, // 1/2
    ...
    /// </summary>
    internal enum SpectralInversion
    {
        NotSet = -1,
        NotDefined = 0,
        Automatic = 1,
    ...
    /// </summary>
    [Flags]
    internal enum ATSCComponentTypeFlags
    {
        None = 0x0,
    ...
    /// </summary>
    [StructLayout(LayoutKind.Sequential)]
    internal struct BDATemplateConnection
    {
