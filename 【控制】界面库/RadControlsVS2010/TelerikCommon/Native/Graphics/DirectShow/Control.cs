...
namespace Telerik.WinControls.UI.Multimedia
{
    ...
    /// </summary>
    [Flags]
    internal enum DispatchFlags : short
    {
        None = 0x0,
        Method =       0x1,
        PropertyGet = 0x2,
    ...
    internal interface IAMCollection
    {
        [PreserveSig]
    ...
    InterfaceType(ComInterfaceType.InterfaceIsDual)]
    internal interface IRegFilterInfo
    {
        [PreserveSig]
        int get_Name([Out, MarshalAs(UnmanagedType.BStr)] out string strName);
    ...
    InterfaceType(ComInterfaceType.InterfaceIsDual)]
    internal interface IMediaTypeInfo
    {
        [PreserveSig]
    ...
    InterfaceType(ComInterfaceType.InterfaceIsDual)]
    internal interface IBasicVideo2 : IBasicVideo
    {
    ...
    InterfaceType(ComInterfaceType.InterfaceIsDual)]
    internal interface IMediaEventEx : IMediaEvent
    {
