...
namespace Telerik.WinControls.UI.Multimedia
{
    ...
    /// </summary>
    [Flags]
    internal enum DMOQualityStatus
    {
        None = 0x0,
        Enabled = 0x1
    }
    ...
    /// </summary>
    [Flags]
    internal enum DMORegisterFlags
    {
        None = 0,
        IsKeyed = 0x00000001
    };
    ...
    /// </summary>
    [Flags]
    internal enum DMOProcessOutput
    {
        None = 0x0,
    ...
    /// </summary>
    [Flags]
    internal enum DMOInputDataBuffer
    {
        None = 0,
        SyncPoint = 0x1,
        Time = 0x2,
    ...
    /// </summary>
    [Flags]
    internal enum DMOInplaceProcess
    {
        Normal = 0,
        Zero = 0x1
    }
    ...
    /// </summary>
    [Flags]
    internal enum DMOInputStreamInfo
    {
        None = 0x0,
        WholeSamples = 0x1,
    ...
    /// </summary>
    [Flags]
    internal enum DMOOutputStreamInfo
    {
        None = 0x0,
        WholeSamples = 0x1,
        SingleSamplePerBuffer = 0x2,
    ...
    /// </summary>
    [Flags]
    internal enum DMOVideoOutputStream
    {
        None = 0x0,
    ...
    sealed internal class DMOCategory
    {
        private DMOCategory()
        {
    ...
    sealed internal class DMOUtils
    {
        [DllImport("msdmo.dll")]
    ...
    sealed internal class DMOResults
    {
        private DMOResults()
        {
            // Prevent people from trying to instantiate this class
    ...
    sealed internal class DMOError
    {
        private DMOError()
        {
            // Prevent people from trying to instantiate this class
    ...
    internal interface IDMOQualityControl
    {
        [PreserveSig]
        int SetNow(
            [In] long rtNow
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IDMOVideoOutputOptimizations
    {
        [PreserveSig]
