...
namespace Telerik.WinControls.UI.Multimedia
{
    ...
    /// </summary>
    [StructLayout(LayoutKind.Sequential)]
    internal struct DvdSubpictureATR
    {
    ...
    /// </summary>
    [StructLayout(LayoutKind.Sequential)]
    internal struct DvdPlaybackLocation
    {
        public int TitleNum;
    ...
    /// </summary>
    internal enum DvdPreferredDisplayMode
    {
    ...
    /// </summary>
    [Flags]
    internal enum DvdTimeCodeFlags
    {
        None = 0,
        FPS25 = 0x00000001,
        FPS30 = 0x00000002,
    ...
    /// </summary>
    internal enum DvdRelativeButton
    {
        Upper = 1,
        Lower = 2,
        Left = 3,
    ...
    /// </summary>
    [Flags]
    internal enum DvdParentalLevel
    {
        None = 0,
        Level8 = 0x8000,
        Level7 = 0x4000,
    ...
    /// </summary>
    internal enum DvdSubPictureLangExt
    {
        NotSpecified = 0,
        CaptionNormal = 1,
        CaptionBig = 2,
    ...
    /// </summary>
    [Flags]
    internal enum DvdKaraokeDownMix
    {
        None = 0,
        Mix_0to0 = 0x0001,
        Mix_1to0 = 0x0002,
    ...
    /// </summary>
    [Flags]
    internal enum DvdKaraokeContents : short
    {
        None = 0,
        GuideVocal1 = 0x0001,
        GuideVocal2 = 0x0002,
    ...
    /// </summary>
    internal enum DvdKaraokeAssignment
    {
        reserved0 = 0,
        reserved1 = 1,
        LR = 2,
    ...
    /// </summary>
    internal enum DvdVideoCompression
    {
        Other = 0,
        Mpeg1 = 1,
        Mpeg2 = 2
    ...
    /// </summary>
    internal enum DvdSubPictureType
    {
        NotSpecified = 0,
        Language = 1,
        Other = 2,
    ...
    /// </summary>
    internal enum DvdSubPictureCoding
    {
        RunLength = 0,
        Extended = 1,
        Other = 2,
    ...
    /// </summary>
    internal enum DvdTextStringType
    {
    ...
    /// </summary>
    [Flags]
    internal enum AMDvdStreamFlags
    {
        None = 0x00,
        Video = 0x01,
        Audio = 0x02,
    ...
    [Flags]
    internal enum AMOverlayNotifyFlags
    {
        None = 0,
    ...
    internal class DvdHMSFTimeCode
    {
        public byte bHours;
    ...
    /// </summary>
    [StructLayout(LayoutKind.Sequential, Pack=1)]
    internal struct DvdPlaybackLocation2
    {
        public int TitleNum;
        public int ChapterNum;
    ...
    /// </summary>
    [StructLayout(LayoutKind.Sequential)]
    internal struct DvdAudioAttributes
    {
    ...
    /// </summary>
    [StructLayout(LayoutKind.Sequential)]
    internal struct DvdMUAMixingInfo
    {
    ...
    /// </summary>
    [StructLayout(LayoutKind.Sequential)]
    internal struct DvdMultichannelAudioAttributes
    {
    ...
    internal class DvdKaraokeAttributes
    {
    ...
    /// </summary>
    [StructLayout(LayoutKind.Sequential)]
    internal struct DvdVideoAttributes
    {
    ...
    /// </summary>
    [StructLayout(LayoutKind.Sequential)]
    internal struct DvdSubpictureAttributes
    {
    ...
    /// </summary>
    [StructLayout(LayoutKind.Sequential)]
    internal class DvdTitleAttributes
    {
    ...
    /// </summary>
    [StructLayout(LayoutKind.Sequential)]
    internal struct DvdMenuAttributes
    {
    ...
    /// </summary>
    [StructLayout(LayoutKind.Sequential)]
    internal struct DvdDecoderCaps
    {
        public int dwSize;
    ...
    /// </summary>
    [StructLayout(LayoutKind.Sequential)]
    internal struct AMDvdRenderStatus
    {
    ...
    internal interface IDvdControl
    {
        [PreserveSig]
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IDDrawExclModeVideo
    {
        [PreserveSig]
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IDDrawExclModeVideoCallback
    {
        [PreserveSig]
        int OnUpdateOverlay(
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IDvdGraphBuilder
    {
        [PreserveSig]
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IDvdControl2
    {
        [PreserveSig]
        int PlayTitle(
            [In] int ulTitle,
