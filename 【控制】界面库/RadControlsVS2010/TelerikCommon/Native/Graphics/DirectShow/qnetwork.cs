...
namespace Telerik.WinControls.UI.Multimedia
{
    ...
    /// </summary>
    [Flags]
    internal enum AMExtendedSeekingCapabilities
    {
        None = 0,
        CanSeek = 1,
        CanScan = 2,
    ...
    internal interface IAMNetShowConfig
    {
        [PreserveSig]
    ...
    InterfaceType(ComInterfaceType.InterfaceIsDual)]
    internal interface IAMChannelInfo
    {
        [PreserveSig]
    ...
    InterfaceType(ComInterfaceType.InterfaceIsDual)]
    internal interface IAMNetworkStatus
    {
        [PreserveSig]
    ...
    InterfaceType(ComInterfaceType.InterfaceIsDual)]
    internal interface IAMNetShowExProps
    {
        [PreserveSig]
    ...
    InterfaceType(ComInterfaceType.InterfaceIsDual)]
    internal interface IAMExtendedErrorInfo
    {
        [PreserveSig]
    ...
    InterfaceType(ComInterfaceType.InterfaceIsDual)]
    internal interface IAMNetShowPreroll
    {
        [PreserveSig]
    ...
    internal interface IDShowPlugin
    {
        [PreserveSig]
    ...
    InterfaceType(ComInterfaceType.InterfaceIsDual)]
    internal interface IAMMediaContent
    {
        [PreserveSig]
    ...
    InterfaceType(ComInterfaceType.InterfaceIsDual)]
    internal interface IAMExtendedSeeking
    {
        [PreserveSig]
    ...
    InterfaceType(ComInterfaceType.InterfaceIsDual)]
    internal interface IAMMediaContent2
    {
        [PreserveSig]
