...
namespace Telerik.WinControls.UI.Multimedia
{
    ...
    internal class DsLong
    {
        ...
        /// VB.Net doesn't support implicit cast. Refer to DirectShowLib.DsGuid.FromInt64 for similar functionality.
        /// <code>
    ...
    internal class DsGuid
    {
        ...
        /// VB.Net doesn't support implicit cast. Refer to DirectShowLib.DsGuid.ToGuid for similar functionality.
        /// <code>
        ...
        /// VB.Net doesn't support implicit cast. Refer to DirectShowLib.DsGuid.FromGuid for similar functionality.
        /// <code>
    ...
    internal class DsRect
    {
        ...
        /// VB.Net doesn't support implicit cast. Refer to DirectShowLib.DsRect.ToRectangle for similar functionality.
        /// <code>
        ...
        /// VB.Net doesn't support implicit cast. Refer to DirectShowLib.DsRect.FromRectangle for similar functionality.
        /// <code>
    ...
    sealed internal class DsResults
    {
        private DsResults()
        {
    ...
    internal class DsROTEntry : IDisposable
    {
        [Flags]
    ...
    internal class DsDevice : IDisposable
    {
#if USING_NET11
    ...
    sealed internal class DsFindPin
    {
        private DsFindPin()
        {
            // Prevent people from trying to instantiate this class
    ...
    sealed internal class DsToString
    {
        private DsToString()
        {
            // Prevent people from trying to instantiate this class
