...
namespace Telerik.WinControls.UI.Multimedia
{
    ...
    sealed internal class DESResults
    {
        private DESResults()
        {
    ...
    sealed internal class DESError
    {
        private DESError()
        {
            // Prevent people from trying to instantiate this class
    ...
    internal class AMTimelineTrack
    {
    }
    ...
    internal class AMTimelineGroup
    {
    }
    ...
    internal class AMTimelineTrans
    {
    }
    ...
    internal class AMTimelineEffect
    {
    }
    ...
    internal class SmartRenderEngine
    {
    }
    ...
    /// </summary>
    [Flags]
    internal enum TimelineMajorType
    {
        None = 0,
        Composite = 1,
        Effect = 0x10,
    ...
    /// </summary>
    [Flags]
    internal enum SFNValidateFlags
    {
        None         = 0x00000000,
        Check        = 0x00000001,
        Popup        = 0x00000002,
    ...
    /// </summary>
    internal enum DexterFTrackSearchFlags
    {
        Bounding = -1,
        ExactlyAt = 0,
        Forwards = 1
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IDxtAlphaSetter : IDXEffect
    {
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IDxtCompositor : IDXEffect
    {
        #region IDXEffect
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IDxtJpeg : IDXEffect
    {
        #region IDXEffect
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IDxtKey : IDXEffect
    {
        #region IDXEffect
    ...
    internal interface IFindCompressorCB
    {
        [PreserveSig]
        int GetCompressor(
    ...
    internal interface IAMErrorLog
    {
        [PreserveSig]
        int LogError(
            int Severity,
    ...
    internal interface IAMSetErrorLog
    {
        [PreserveSig]
        int get_ErrorLog(
    ...
    internal interface IAMTimeline
    {
        [PreserveSig]
        int CreateEmptyNode(
    ...
    internal interface IAMTimelineComp
    {
        [PreserveSig]
        int VTrackInsBefore(
    ...
    internal interface IAMTimelineEffect
    {
        [PreserveSig]
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IAMTimelineEffectable
    {
        [PreserveSig]
        int EffectInsBefore(
            IAMTimelineObj pFX,
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IAMTimelineGroup
    {
        [PreserveSig]
        int SetTimeline(
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IAMTimelineObj
    {
        [PreserveSig]
        int GetStartStop(
            out long pStart,
    ...
    internal interface IAMTimelineSplittable
    {
        [PreserveSig]
        int SplitAt(
            long Time
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IAMTimelineSrc
    {
        [PreserveSig]
        int GetMediaTimes(
            out long pStart,
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IAMTimelineTrack
    {
        [PreserveSig]
        int SrcAdd(
    ...
    internal interface IAMTimelineTrans
    {
        [PreserveSig]
        int GetCutPoint(
            out long pTLTime
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IAMTimelineTransable
    {
        [PreserveSig]
        int TransAdd(
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IAMTimelineVirtualTrack
    {
        [PreserveSig]
    ...
    internal interface IMediaLocator
    {
        [PreserveSig]
        int FindMediaFile(
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface ISmartRenderEngine
    {
        [PreserveSig]
    ...
    internal interface IRenderEngine2
    {
        [PreserveSig]
        int SetResizerGUID(
            [In] Guid ResizerGuid
