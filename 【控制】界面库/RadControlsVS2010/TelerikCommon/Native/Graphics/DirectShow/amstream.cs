...
namespace Telerik.WinControls.UI.Multimedia
{
    ...
    internal interface IAMMediaStream : IMediaStream
    {
    ...
    internal interface IAMMultiMediaStream : IMultiMediaStream
    {
    ...
    internal interface IAMMediaTypeStream : IMediaStream
    {
        #region IMediaStream Methods
    ...
    internal interface IAMMediaTypeSample : IStreamSample
    {
    ...
    InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IMediaStreamFilter : IBaseFilter
    {
