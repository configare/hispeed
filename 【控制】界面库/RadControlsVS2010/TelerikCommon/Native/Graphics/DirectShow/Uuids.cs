...
namespace Telerik.WinControls.UI.Multimedia
{
    ...
    internal class FilterGraphNoThread
    {
    }
    ...
    internal class DvdGraphBuilder
    {
    }
    ...
    internal class StreamBufferConfig
    {
    }
    ...
    internal class StreamBufferComposeRecording
    {
    }
    ...
    internal class SeekingPassThru
    {
    }
    ...
    internal class MediaPropertyBag
    {
    }
    ...
    internal class InternalScriptCommandRenderer
    {
    }
    ...
    internal class BroadcastEventService
    {
    }
    ...
    internal class DMOWrapperFilter
    {
    }
    ...
    internal class StreamBufferSink
    {
    }
    ...
    internal class StreamBufferSource
    {
    }
    ...
    internal class VideoMixingRenderer
    {
    }
    ...
    internal class VideoRendererDefault
    {
    }
    ...
    internal class CMpegAudioCodec
    {
    }
    ...
    internal class CMpegVideoCodec
    {
    }
    ...
    internal class QuickTimeParser
    {
    }
    ...
    internal class VideoPortManager
    {
    }
    ...
    internal class Mpeg2VideoStreamAnalyzer
    {
    }
    ...
    sealed internal class FilterCategory
    {
        ...
        /// <summary> KSCATEGORY_DATADECOMPRESSOR_and_CLSID_DVDHWDecodersCategory </summary>
    ...
    sealed internal class VMRClsId
    {
        private VMRClsId()
        {
            // Prevent people from trying to instantiate this class
    ...
    sealed internal class TVEClsId
    {
        private TVEClsId()
        {
            // Prevent people from trying to instantiate this class
    ...
    sealed internal class ENCAPIClsId
    {
        private ENCAPIClsId()
        {
            // Prevent people from trying to instantiate this class
    ...
    sealed internal class MediaType
    {
        private MediaType()
        {
            // Prevent people from trying to instantiate this class
    ...
    sealed internal class MediaSubType
    {
    ...
    sealed internal class FormatType
    {
        private FormatType()
        {
            // Prevent people from trying to instantiate this class
    ...
    sealed internal class PropSetID
    {
        private PropSetID()
        {
            // Prevent people from trying to instantiate this class
    ...
    sealed internal class PinCategory
    {
        private PinCategory()
        {
            // Prevent people from trying to instantiate this class
    ...
    sealed internal class FindDirection
    {
    ...
    sealed internal class TimeFormat
    {
        private TimeFormat()
        {
            // Prevent people from trying to instantiate this class
    ...
    sealed internal class PropertyPages
    {
    ...
    sealed internal class BDANodeCategory
    {
