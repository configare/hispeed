...
namespace Telerik.WinControls
{
    ...
    internal static class NativeMethods
    {
        ...
        {
            Telerik.WinControls.NativeMethods.HWND_TOP = new HandleRef(null, IntPtr.Zero);
            Telerik.WinControls.NativeMethods.HWND_TOPMOST = new HandleRef(null, new IntPtr(-1));
            Telerik.WinControls.NativeMethods.HWND_BOTTOM = new HandleRef(null, (IntPtr)1);
            Telerik.WinControls.NativeMethods.NullHandleRef = new HandleRef(null, IntPtr.Zero);
            Telerik.WinControls.NativeMethods.wmMouseEnterMessage = -1;

            // RadToolTip
            if (Marshal.SystemDefaultCharSize == 1)
            {
                Telerik.WinControls.NativeMethods.TTM_ADDTOOL = 0x404;
                Telerik.WinControls.NativeMethods.TTM_SETTITLE = 0x420;
                Telerik.WinControls.NativeMethods.TTM_DELTOOL = 0x405;
                Telerik.WinControls.NativeMethods.TTM_NEWTOOLRECT = 0x406;
                Telerik.WinControls.NativeMethods.TTM_GETTOOLINFO = 0x408;
                Telerik.WinControls.NativeMethods.TTM_SETTOOLINFO = 0x409;
                Telerik.WinControls.NativeMethods.TTM_HITTEST = 0x40a;
                Telerik.WinControls.NativeMethods.TTM_GETTEXT = 0x40b;
                Telerik.WinControls.NativeMethods.TTM_UPDATETIPTEXT = 0x40c;
                Telerik.WinControls.NativeMethods.TTM_ENUMTOOLS = 0x40e;
                Telerik.WinControls.NativeMethods.TTM_GETCURRENTTOOL = 0x40f;
            }
            else
            {
                Telerik.WinControls.NativeMethods.TTM_ADDTOOL = 0x432;
                Telerik.WinControls.NativeMethods.TTM_SETTITLE = 0x421;
                Telerik.WinControls.NativeMethods.TTM_DELTOOL = 0x433;
                Telerik.WinControls.NativeMethods.TTM_NEWTOOLRECT = 0x434;
                Telerik.WinControls.NativeMethods.TTM_GETTOOLINFO = 0x435;
                Telerik.WinControls.NativeMethods.TTM_SETTOOLINFO = 0x436;
                Telerik.WinControls.NativeMethods.TTM_HITTEST = 0x437;
                Telerik.WinControls.NativeMethods.TTM_GETTEXT = 0x438;
                Telerik.WinControls.NativeMethods.TTM_UPDATETIPTEXT = 0x439;
                Telerik.WinControls.NativeMethods.TTM_ENUMTOOLS = 0x43a;
                Telerik.WinControls.NativeMethods.TTM_GETCURRENTTOOL = 0x43b;
            }
        }
        ...
        public static int WM_MOUSEENTER
        {
            get
            {
                if (Telerik.WinControls.NativeMethods.wmMouseEnterMessage == -1)
                {
                    Telerik.WinControls.NativeMethods.wmMouseEnterMessage = RegisterWindowMessage("WinFormsMouseEnter");
                }
                return Telerik.WinControls.NativeMethods.wmMouseEnterMessage;
            }
        }
        ...
        public struct RECT
        {
            ...
            public static Telerik.WinControls.NativeMethods.RECT FromXYWH(int x, int y, int width, int height)
            {
                return new Telerik.WinControls.NativeMethods.RECT(x, y, x + width, y + height);
            }
        ...
        public class TOOLINFO_TOOLTIP
        {
            ...
            public IntPtr hwnd;
            public IntPtr uId;
            public Telerik.WinControls.NativeMethods.RECT rect;
            public IntPtr hinst;
            public IntPtr lpszText;
            public IntPtr lParam;
            public TOOLINFO_TOOLTIP()
            {
                this.cbSize = Marshal.SizeOf(typeof(Telerik.WinControls.NativeMethods.TOOLINFO_TOOLTIP));
        ...
        {
            public Telerik.WinControls.NativeMethods.POINT ptReserved;
            public Telerik.WinControls.NativeMethods.POINT ptMaxSize;
            public Telerik.WinControls.NativeMethods.POINT ptMaxPosition;
            public Telerik.WinControls.NativeMethods.POINT ptMinTrackSize;
            public Telerik.WinControls.NativeMethods.POINT ptMaxTrackSize;
            public MINMAXINFO()
            {
            }
        }
        ...
        public class TRACKMOUSEEVENT
        {
            ...
            {
                this.cbSize = Marshal.SizeOf(typeof(Telerik.WinControls.NativeMethods.TRACKMOUSEEVENT));
        ...
        public class LOGFONT
        {
            ...
            public LOGFONT(Telerik.WinControls.NativeMethods.LOGFONT lf)
            {
        ...
        public sealed class CommonHandles
        {
            ...
            {
                Telerik.WinControls.NativeMethods.CommonHandles.Accelerator = Telerik.WinControls.HandleCollector.RegisterType("Accelerator", 80, 50);
                Telerik.WinControls.NativeMethods.CommonHandles.Cursor = Telerik.WinControls.HandleCollector.RegisterType("Cursor", 20, 500);
                Telerik.WinControls.NativeMethods.CommonHandles.EMF = Telerik.WinControls.HandleCollector.RegisterType("EnhancedMetaFile", 20, 500);
                Telerik.WinControls.NativeMethods.CommonHandles.Find = Telerik.WinControls.HandleCollector.RegisterType("Find", 0, 0x3e8);
                Telerik.WinControls.NativeMethods.CommonHandles.GDI = Telerik.WinControls.HandleCollector.RegisterType("GDI", 50, 500);
                Telerik.WinControls.NativeMethods.CommonHandles.HDC = Telerik.WinControls.HandleCollector.RegisterType("HDC", 100, 2);
                Telerik.WinControls.NativeMethods.CommonHandles.CompatibleHDC = Telerik.WinControls.HandleCollector.RegisterType("ComptibleHDC", 50, 50);
                Telerik.WinControls.NativeMethods.CommonHandles.Icon = Telerik.WinControls.HandleCollector.RegisterType("Icon", 20, 500);
                Telerik.WinControls.NativeMethods.CommonHandles.Kernel = Telerik.WinControls.HandleCollector.RegisterType("Kernel", 0, 0x3e8);
                Telerik.WinControls.NativeMethods.CommonHandles.Menu = Telerik.WinControls.HandleCollector.RegisterType("Menu", 30, 0x3e8);
                Telerik.WinControls.NativeMethods.CommonHandles.Window = Telerik.WinControls.HandleCollector.RegisterType("Window", 5, 0x3e8);
            }
        ...
        public static class Util
        {
            private static int GetEmbeddedNullStringLengthAnsi(string s)
            {
                ...
                if (num1 > -1)
                {
                    ...
                    return ((Telerik.WinControls.NativeMethods.Util.GetPInvokeStringLength(text1) + Telerik.WinControls.NativeMethods.Util.GetEmbeddedNullStringLengthAnsi(text2)) + 1);
                }
                return Telerik.WinControls.NativeMethods.Util.GetPInvokeStringLength(s);
            }
            ...
            public static int GetPInvokeStringLength(string s)
            {
                ...
                if (s.IndexOf('\0') > -1)
                {
                    return Telerik.WinControls.NativeMethods.Util.GetEmbeddedNullStringLengthAnsi(s);
                }
                return Telerik.WinControls.NativeMethods.lstrlen(s);
            }
            ...
            {
                return Telerik.WinControls.NativeMethods.Util.HIWORD((int)((long)n));
            }
            ...
            {
                return Telerik.WinControls.NativeMethods.Util.LOWORD((int)((long)n));
            }
            ...
            {
                return Telerik.WinControls.NativeMethods.Util.SignedHIWORD((int)((long)n));
            }
            ...
            {
                return Telerik.WinControls.NativeMethods.Util.SignedLOWORD((int)((long)n));
            }
        ...
        [DllImport("user32.dll", CharSet = CharSet.Auto)]
        public static extern IntPtr SendMessage(HandleRef hWnd, int msg, int wParam, Telerik.WinControls.NativeMethods.POINT lParam);
        ...
        [DllImport("user32.dll", CharSet = CharSet.Auto, ExactSpelling = true)]
        public static extern bool RedrawWindow(HandleRef hwnd, ref Telerik.WinControls.NativeMethods.RECT rcUpdate, HandleRef hrgnUpdate, int flags);

        [DllImport("user32.dll", CharSet = CharSet.Auto, ExactSpelling = true)]
        public static extern bool GetWindowRect(HandleRef hWnd, [In, Out] ref Telerik.WinControls.NativeMethods.RECT rect);

        [DllImport("user32.dll", EntryPoint = "WindowFromPoint", CharSet = CharSet.Auto, ExactSpelling = true)]
        public static extern IntPtr _WindowFromPoint(Telerik.WinControls.NativeMethods.POINTSTRUCT pt);
        ...
        [DllImport("user32.dll", CharSet = CharSet.Auto, ExactSpelling = true)]
        public static extern int ClientToScreen(HandleRef hWnd, [In, Out] Telerik.WinControls.NativeMethods.POINT pt);

        [DllImport("user32.dll", CharSet = CharSet.Auto, ExactSpelling = true)]
        public static extern bool AdjustWindowRectEx(ref Telerik.WinControls.NativeMethods.RECT lpRect, int dwStyle, bool bMenu, int dwExStyle);

        [DllImport("user32.dll", CharSet = CharSet.Auto, ExactSpelling = true)]
        public static extern int MapWindowPoints(HandleRef hWndFrom, HandleRef hWndTo, [In, Out] ref Telerik.WinControls.NativeMethods.RECT rect, int cPoints);
        ...
        private static extern IntPtr IntCreateBrushIndirect(Telerik.WinControls.NativeMethods.LOGBRUSH lb);
        ...
        public static extern bool _TrackMouseEvent(Telerik.WinControls.NativeMethods.TRACKMOUSEEVENT tme);

        [DllImport("comctl32.dll")]
        public static extern bool InitCommonControlsEx(Telerik.WinControls.NativeMethods.INITCOMMONCONTROLSEX icc);

        #endregion

        public static IntPtr GetDC(HandleRef hWnd)
        {
            return Telerik.WinControls.HandleCollector.Add(IntGetDC(hWnd), Telerik.WinControls.NativeMethods.CommonHandles.HDC);
        }

        public static IntPtr GetDCEx(HandleRef hWnd, HandleRef hrgnClip, int flags)
        {
            return Telerik.WinControls.HandleCollector.Add(IntGetDCEx(hWnd, hrgnClip, flags), Telerik.WinControls.NativeMethods.CommonHandles.HDC);
        }

        public static IntPtr GetWindowDC(HandleRef hWnd)
        {
            return Telerik.WinControls.HandleCollector.Add(IntGetWindowDC(hWnd), Telerik.WinControls.NativeMethods.CommonHandles.HDC);
        }

        public static IntPtr CreateCompatibleDC(HandleRef hDC)
        {
            return Telerik.WinControls.HandleCollector.Add(IntCreateCompatibleDC(hDC), Telerik.WinControls.NativeMethods.CommonHandles.CompatibleHDC);
        }

        public static int ReleaseDC(HandleRef hWnd, HandleRef hDC)
        {
            Telerik.WinControls.HandleCollector.Remove((IntPtr)hDC, Telerik.WinControls.NativeMethods.CommonHandles.HDC);
        ...
        {
            Telerik.WinControls.NativeMethods.POINTSTRUCT pointstruct1 = new Telerik.WinControls.NativeMethods.POINTSTRUCT(x, y);
            return _WindowFromPoint(pointstruct1);
        }

        public static bool DeleteObject(HandleRef hObject)
        {
            Telerik.WinControls.HandleCollector.Remove((IntPtr)hObject, Telerik.WinControls.NativeMethods.CommonHandles.GDI);
            return IntDeleteObject((IntPtr)hObject);
        }

        #region GetObject

        public static int GetObject(HandleRef hObject, Telerik.WinControls.NativeMethods.LOGBRUSH lb)
        {
            return GetObject(hObject, Marshal.SizeOf(typeof(Telerik.WinControls.NativeMethods.LOGBRUSH)), lb);
        }
        ...
        {
            return Telerik.WinControls.HandleCollector.Add(IntCreateBitmap(nWidth, nHeight, nPlanes, nBitsPerPixel, lpvBits), CommonHandles.GDI);
        }

        public static IntPtr CreateBitmap(int nWidth, int nHeight, int nPlanes, int nBitsPerPixel, byte[] lpvBits)
        {
            return Telerik.WinControls.HandleCollector.Add(IntCreateBitmapByte(nWidth, nHeight, nPlanes, nBitsPerPixel, lpvBits), CommonHandles.GDI);
        }

        public static IntPtr CreateBitmap(int nWidth, int nHeight, int nPlanes, int nBitsPerPixel, short[] lpvBits)
        {
            return Telerik.WinControls.HandleCollector.Add(IntCreateBitmapShort(nWidth, nHeight, nPlanes, nBitsPerPixel, lpvBits), CommonHandles.GDI);
        }

        public static IntPtr CreateBrushIndirect(Telerik.WinControls.NativeMethods.LOGBRUSH lb)
        {
            return Telerik.WinControls.HandleCollector.Add(IntCreateBrushIndirect(lb), Telerik.WinControls.NativeMethods.CommonHandles.GDI);
        }
