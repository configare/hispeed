...
{
    internal class ContourGeneratorUInt32 : ContourGenerator<UInt32>
    {
        protected override UInt32 GetNoDataValueOutsideAOI()
        {
            return (UInt32)_noData;
        }

        protected override bool CheckIsContained(UInt32 v1, UInt32 v2, UInt32 val)
        {
            if (v1 == v2)
                return false;
            if (v1 == val)
        ...
        protected override UInt32 ToTValue(double v)
        {
            return (UInt32)v;
        }
