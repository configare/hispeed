...
{
    internal class ContourGeneratorInt32 : ContourGenerator<Int32>
    {
        protected override Int32 GetNoDataValueOutsideAOI()
        {
            return (Int32)_noData;
        }

        protected override bool CheckIsContained(Int32 v1, Int32 v2, Int32 val)
        {
            if (v1 == v2)
                return false;
            if (v1 == val)
        ...
        protected override Int32 ToTValue(double v)
        {
            return (Int32)v;
        }
