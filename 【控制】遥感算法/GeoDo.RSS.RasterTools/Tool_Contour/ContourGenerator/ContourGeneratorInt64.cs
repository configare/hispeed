...
{
    internal class ContourGeneratorInt64 : ContourGenerator<Int64>
    {
        protected override Int64 GetNoDataValueOutsideAOI()
        {
            return (Int64)_noData;
        }

        protected override bool CheckIsContained(Int64 v1, Int64 v2, Int64 val)
        {
            if (v1 == v2)
                return false;
            if (v1 == val)
        ...
        protected override Int64 ToTValue(double v)
        {
            return (Int64)v;
        }
