...
namespace GeoDo.FileProject
{
    ...
    public class NOAA_1A5FileProjector : FileProjector
    {
        ...
        public NOAA_1A5FileProjector()
            : base()
        {
            _name = "NOAA_1A5";
            _fullname = "NOAA_1A5轨道文件投影";
        ...
        private void GetBlockNumber(Size size, out int blockXNum, out int blockYNum, out int blockWidth, out int blockHeight)
        {
            ...
            blockHeight = h;
            int MaxX = w;
            int MaxY = 5120 * 2048 / w; //1024* 5 * 2048 = 5120*2048=10485760
...
NOAA19
        ...
        v[0] = 2659.7952f; v[1] = 928.1460f; v[2] = 833.2532f;
        */
        private void CreateEvABV(int sateIdentify)
        {
            switch (sateIdentify)
            {
                case 4://"NOAA15"
