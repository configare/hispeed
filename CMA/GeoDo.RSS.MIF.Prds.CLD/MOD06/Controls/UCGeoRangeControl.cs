...
namespace GeoDo.RSS.MIF.Prds.CLD
{
    public partial class UCGeoRangeControl : UserControl
    {
        ...
        public void SetGeoEnvelope(PrjEnvelope geoEnvelope)
        {
            try
            {
                txtMinLon.Text = geoEnvelope.MinX.ToString();
                txtMinLat.Text = geoEnvelope.MinY.ToString();
                txtMaxLon.Text = geoEnvelope.MaxX.ToString();
                txtMaxLat.Text = geoEnvelope.MaxY.ToString();
            }
            finally
            {
            }
