namespace GeoDo.RSS.MIF.Prds.CLD
{
    partial class UCGeoRangeControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.txtMinLat = new GeoDo.RSS.MIF.Prds.CLD.DoubleTextBox();
            this.txtMaxLon = new GeoDo.RSS.MIF.Prds.CLD.DoubleTextBox();
            this.txtMinLon = new GeoDo.RSS.MIF.Prds.CLD.DoubleTextBox();
            this.txtMaxLat = new GeoDo.RSS.MIF.Prds.CLD.DoubleTextBox();
            this.SuspendLayout();
            // 
            // label1
            // 
