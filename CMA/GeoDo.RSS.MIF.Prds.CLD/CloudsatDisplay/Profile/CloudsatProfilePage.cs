...
{
    public partial class CloudsatProfilePage :ToolWindow, ISmartWindow
    {
        private EventHandler _onWindowClosed;
        private UCClousatSingleProfile _firstPageContent;

        public CloudsatProfilePage()
        {
            InitializeComponent();
        }

        public CloudsatProfilePage(ISmartSession smartSession):this()
        {
