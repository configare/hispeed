...
{
    public partial class frmStatRegionTemplates : Form
    {
        ...
        public frmStatRegionTemplates(Size size, CoordEnvelope coordEenvelope, float resolution)
        {
            _size = size;
