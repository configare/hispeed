namespace GeoDo.RSS.UI.AddIn.BatchProjectionMosaic
{
    partial class UCGeoRangeControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.txtMinLat = new GeoDo.RSS.UI.AddIn.BatchProjectionMosaic.DoubleTextBox();
            this.txtMaxLon = new GeoDo.RSS.UI.AddIn.BatchProjectionMosaic.DoubleTextBox();
            this.txtMinLon = new GeoDo.RSS.UI.AddIn.BatchProjectionMosaic.DoubleTextBox();
            this.txtMaxLat = new GeoDo.RSS.UI.AddIn.BatchProjectionMosaic.DoubleTextBox();
            this.SuspendLayout();
            // 
            // label1
            // 
