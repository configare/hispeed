...
{
    public class SubProductSTATASL : CmaMonitoringSubProduct
    {
        private IContextMessage _contextMessage = null;

        public SubProductSTATASL(SubProductDef subProductDef)
            : base(subProductDef)
        {
        ...
        {
            return AreaStatResult<Int16>("气溶胶","ASL", (v) => { return v == 1; });
        }
