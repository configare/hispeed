...
{
    public class SubProductIMGLST : CmaMonitoringSubProduct
    {
        private List<ProductColor> _legendItems = new List<ProductColor>();//图例项
        private ProductColorTable _colorTable;

        public SubProductIMGLST(SubProductDef subProductDef)
            : base(subProductDef)
        {
        ...
        private void SetOtherColorTable(string season, ref string colorTableName)
        {
            switch (season)
            {
                case "Spring":
                ...
                case "Winter":
                    ...
                    break;
                case "SummerHight":
                    colorTableName = "LSTDBHL";
                    break;

            }
        }

        private void Set0SRIColorTable(string season, ref string colorTableName)
        {
            switch (season)
            {
                case "Spring":
                    colorTableName = "LSTRSP";
                    break;
                case "Summer":
                    colorTableName = "LSTRSU";
                    break;
                case "Autumn":
                    colorTableName = "LSTRFA";
                    break;
                case "Winter":
                    colorTableName = "LSTRWI";
                    break;
                case "SummerHight":
                    colorTableName = "LSTRHL";
                    break;
            }
        }
