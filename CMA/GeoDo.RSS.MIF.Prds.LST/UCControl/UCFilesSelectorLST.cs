...
namespace GeoDo.RSS.MIF.Prds.LST
{
    ...
    /// </summary>
    public partial class UCFilesSelectorLST : UserControl, IArgumentEditorUI
    {
        ...
        private string _saveFile = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "MonitoringProductArgs", "LST", "局地文件夹路径.txt");

        public UCFilesSelectorLST()
        {
            InitializeComponent();
            InitArgument();
