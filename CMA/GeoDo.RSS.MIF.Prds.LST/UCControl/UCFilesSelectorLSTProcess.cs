...
namespace GeoDo.RSS.MIF.Prds.LST
{
    ...
    /// </summary>
    public partial class UCFilesSelectorLSTProcess : UserControl, IArgumentEditorUI
    {
        ...
        private string _saveFile = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "MonitoringProductArgs", "LST", "产品文件夹路径.txt");

        public UCFilesSelectorLSTProcess()
        {
            InitializeComponent();
            InitArgument();
