...
{
    public class SubProductLTLRLST : CmaMonitoringSubProduct
    {
        private IContextMessage _contextMessage;

        public SubProductLTLRLST(SubProductDef subProductDef)
            : base(subProductDef)
        {
        ...
        public override IExtractResult Make(Action<int, string> progressTracker, IContextMessage contextMessage)
        {
            ...
            if (_argumentProvider.GetArg("AlgorithmName") == null)
                return null;
            if (_argumentProvider.GetArg("AlgorithmName").ToString() == "LTLREAlgorithm")
            {
                return LTLREAlgorithm(progressTracker);
            }
            return null;
        }
        ...
        private bool TimeValue(Int16 pixelValue, Int16[] cloudValues, Int16[] waterValues, Int16[] invaildValues, Int16 timeValue, Int16 maxLst, out Int16 currTimeValue)
        {
