...
{
    public class SubProductTFREICE : CmaMonitoringSubProduct
    {

        public SubProductTFREICE(SubProductDef subProductDef)
            : base(subProductDef)
        {
        ...
        private IExtractResult TFREAlgorithm(Action<int, string> progressTracker)
        {
            ...
            return new FileExtractResult("ICE", workFilename, true);
        }
    }
}
