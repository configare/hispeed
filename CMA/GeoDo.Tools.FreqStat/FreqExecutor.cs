...
{
    public class FreqExecutor
    {
        string _argFileName;
        Action<int, string> _progress;
        FreqStatArg _argument;

        public FreqExecutor(string argFileName, Action<int, string> Progress)
        {
            _argFileName = argFileName;
            _progress = Progress;
            _argument = new FreqStatArg(_argFileName);
        }
