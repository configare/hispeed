...
namespace GeoDo.RSS.MIF.Prds.UHE
{
    ...
    /// </summary>
    public partial class UCFilesSelectorUHE : UserControl, IArgumentEditorUI
    {
        ...
        private string _saveFile = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "MonitoringProductArgs", "UHE", "局地文件夹路径.txt");

        public UCFilesSelectorUHE()
        {
            InitializeComponent();
            InitArgument();
