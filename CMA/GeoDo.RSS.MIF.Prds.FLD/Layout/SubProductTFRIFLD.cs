...
{
    public class SubProductTFRIFLD : CmaMonitoringSubProduct
    {
        ...
        private string _subColorname="TFRI";

        public SubProductTFRIFLD(SubProductDef subProductDef)
            : base(subProductDef)
        {
        ...
        private IExtractResult FLDTFRI()
        {
            ...
            _shpFiles = shpFiles;
            ApplyMcd(_shpFiles, @"SystemData\ProductArgs\长序列水体边缘线专题图文档.mcd");
