...
namespace GeoDo.RSS.UI.AddIn.HdService
{
    public partial class queryUIProvider : UserControl,IUIGroupProvider
    {
        ...
        //private RadDropDownListElement _sensorEle = new RadDropDownListElement();

        public queryUIProvider()
        {
            InitializeComponent();
            CreateMenuGroup();
            //_sensorEle.Items.Add("VIRR");
            //_sensorEle.Items.Add("MERSI");
            //_group.Items.Add(_sensorEle);
        }
        ...
        void _rasterDats_Click(object sender, EventArgs e)
        {
            ExecuteCommand(39003,"RasterData");
        }
        ...
        private string GetSatellite()
        {
            if (sate1.ToggleState == Telerik.WinControls.Enumerations.ToggleState.On)
                return "FY3A";
            if (sate2.ToggleState == Telerik.WinControls.Enumerations.ToggleState.On)
                return "FY3B";
            return "FY3C";
        }
