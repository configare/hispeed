...
{
    public class CmaDrtMonitoringSubProduct : CmaMonitoringSubProduct
    {
        public CmaDrtMonitoringSubProduct()
            : base()
        { }

        public CmaDrtMonitoringSubProduct(SubProductDef subProductDef)
            : base(subProductDef)
        { }
