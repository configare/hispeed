...
{
    public class SubProductSTATDRT : CmaMonitoringSubProduct
    {
        private IContextMessage _contextMessage = null;

        public SubProductSTATDRT(SubProductDef subProductDef)
            : base(subProductDef)
        {
        ...
        public override IExtractResult Make(Action<int, string> progressTracker, IContextMessage contextMessage)
        {
            ...
            SortedDictionary<float, float> ndviRegions = _argumentProvider.GetArg("VTIRegion") as SortedDictionary<float, float>;
