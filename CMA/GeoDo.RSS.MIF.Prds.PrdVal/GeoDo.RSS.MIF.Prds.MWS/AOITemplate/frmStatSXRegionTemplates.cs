...
{
    public partial class frmStatSXRegionTemplates : Form
    {
        ...
        public frmStatSXRegionTemplates()
        {
            InitializeComponent();
        ...
        public frmStatSXRegionTemplates(Size size, CoordEnvelope coordEenvelope, float resolution)
        {
            _size = size;
        ...
        private void InitCategories()
        {
            ...
            VectorTempFeatureCategory c = new VectorTempFeatureCategory("县市行政区域", VectorAOITemplate.FindVectorFullname("县级行政区域_面.shp"));
                if (c != null)
                {
