...
{
    public class SubProductFLANFIR: CmaMonitoringSubProduct
    {
        private IContextMessage _contextMessage = null;

        public SubProductFLANFIR()
            : base()
        {

        }

        public SubProductFLANFIR(SubProductDef subProductDef)
            : base(subProductDef)
        {
        ...
        public override IExtractResult Make(Action<int, string> progressTracker, IContextMessage contextMessage)
        {
            ...
            return CalcFLAN(progressTracker);
        }

        private IExtractResult CalcFLAN(Action<int, string> progressTracker)
        {
            ...
            try
            {
                ...
                rms.Add(rm);
                //输出文件准备（作为输入栅格并集处理）
                RasterIdentify ri = GetRasterIdentifyID(fiflFile);
