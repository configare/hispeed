...
namespace GeoDo.Smart.Tools.MODLSTPro
{
    public static class Utility
    {
        ...
        /// <summary>
        /// 获取HDF4拼接HDF5时，HDF4各级属性对应的基础数据类型
        /// </summary>
        /// <param name="dataType"></param>
        /// <returns></returns>
        public static Type GetAttrType(HDF4Helper.DataTypeDefinitions dataType)
        {
            switch (dataType)
            {
                case HDF4Helper.DataTypeDefinitions.DFNT_INT8:
        ...
        /// <summary>
        /// 获取HDF4拼接HDF5时，HDF4数据类型对应的基础数据类型
        /// </summary>
        /// <param name="dataType"></param>
        /// <returns></returns>
        public static Type GetDataType(HDF4Helper.DataTypeDefinitions dataType)
        {
            switch (dataType)
            {
                case HDF4Helper.DataTypeDefinitions.DFNT_INT8:
