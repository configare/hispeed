...
{
    public partial class frmStatCustomSubRegionTemplates : Form
    {
        ...
        private Dictionary<string, string> _fileDirList = null;

        public frmStatCustomSubRegionTemplates(Size size, CoordEnvelope coordEenvelope, float resolution,Dictionary<string,string> fileDirList)
        {
            _size = size;
            _envelope = new Envelope(coordEenvelope.MinX, coordEenvelope.MinY, coordEenvelope.MaxX, coordEenvelope.MaxY);
            _resolution = resolution;
            _fileDirList = new Dictionary<string, string>(fileDirList);
            InitializeComponent();
            //_customVectorRegionFilename = AppDomain.CurrentDomain.BaseDirectory + "CustomVectorRegion.mainfestfile";
            InitCategories(fileDirList);
        }
