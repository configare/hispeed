...
{
    public static class TileComputer
    {
        ...
        public static int GetLevelOfDetail(SizeF requestSize, SizeF fullSize,int maxLevelOfDetail)
        {
            float w = Math.Max(requestSize.Width, requestSize.Height);
            float factor = (fullSize.Width / w);
            /*
            ...
            for (int i = 1, basefactor = 1; i < maxLevelOfDetail; i++, basefactor *= 2)
            {
        ...
        public static int[] ComputeTiles(int levelOfDetail, RectangleF requestRect)
        {
