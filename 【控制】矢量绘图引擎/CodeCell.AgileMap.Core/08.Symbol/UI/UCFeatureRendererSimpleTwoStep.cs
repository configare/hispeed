...
{
    public partial class UCFeatureRendererSimpleTwoStep : UCFeatureRendererControlBase
    {
        public UCFeatureRendererSimpleTwoStep()
        {
            InitializeComponent();
        ...
        protected override void SetLayerAfter()
        {
            ...
            if (_layer.Renderer is SimpleTwoStepFeatureRenderer)
                _symbol = (_layer.Renderer as SimpleTwoStepFeatureRenderer).Symbol;
            ...
            _layer.Renderer = new SimpleTwoStepFeatureRenderer(_symbol);
            if (_layer.Renderer != null)
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            if (_layer.Renderer is SimpleTwoStepFeatureRenderer)
            {
                ...
                (_layer.Renderer as SimpleTwoStepFeatureRenderer).Symbol = _symbol;
