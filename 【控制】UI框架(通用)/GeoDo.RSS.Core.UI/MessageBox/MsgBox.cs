...
namespace GeoDo.RSS.Core.UI
{
    public static class MsgBox
    {
        ...
        public static DialogResult ShowQuestionYesNoCancel(string sQuestion)
        {
            return MessageBox.Show(sQuestion, cstQuestion, MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question);
        }
    }
}
