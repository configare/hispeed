...
namespace GeoDo.RSS.UI.AddIn.Theme
{
    ...
    public partial class ExtractPanelWindow : ToolWindow, ISmartToolWindow, IExtractPanelWindow
    {
        protected int _id;
        ...
        public bool IsKeepUserControl
        {
            ...
            {
                bool brs = false;
                if (_session == null || _session.MonitoringSession == null)
                    return brs;
                IMonitoringSession moniSession = _session.MonitoringSession as IMonitoringSession;
                if (moniSession.ActiveMonitoringSubProduct == null)
                    return brs;
                return moniSession.ActiveMonitoringSubProduct.Definition.IsKeepUserControl;
            }
